...
<body>
    ...
    <main>
		 ...
		 <center><img style="margin-top:20px;" src="https://i.hizliresim.com/5xns4qf.png"  width="150">
</center>
...
font-size: 19px;
margin-top:-5px;
"><b><i style="margin-top:-2px;" class="fas fa-user-cog"></i> Hesap Yönetim Paneli<b><h1>
...
<h5 style="font-size:15px; color: #999; font-weight:400; top:10px; position:relative; ">&copy; Coded and Designed by <b>lilvlad<b><h5>
<h4 style="color: #999;">Thanks RaizyMedia</h4>
